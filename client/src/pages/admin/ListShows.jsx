        ...
        <table className="w-full border-collapse rounded-lg overflow-hidden shadow-lg backdrop-blur-md">
          <thead>
            <tr className="bg-primary-700/40 text-left text-white">
              ...
              <th className="p-3 font-semibold tracking-wide">Total Bookings</th>
          ...
          <tbody className="text-sm font-light">
            {activeShows.map((show, index) => (
              ...
              >
                <td className="p-3 min-w-45 pl-5 text-white">{show.movie}</td>
                <td className="p-3 text-primary-200">{dateFormat(show.showDateTime)}</td>
